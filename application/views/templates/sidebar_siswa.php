...
<ul class="navbar-nav bg-gradient sidebar sidebar-dark accordion " id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center">
        <div class="sidebar-brand-icon ">
            <img src="<?= base_url() ?>assets/img/pelnus/logo.ico" width="60px" alt="">
        </div>
    ...
    <li class="nav-item active">
        <a href="<?= base_url('user/kelola_data/data_saya') ?>" class="nav-link">
            <i class="fas fa-fw fa-user text-black-50"></i>
    ...
    <li class="nav-item active">
        <a href="<?= base_url('user/kelola_data/daftar') ?>" class="nav-link">
            <i class="fa fa-fw fa-file text-black-50"></i>
            <span class="text-black-50">Daftar</span>
        </a>
    </li>

    <li class="nav-item active">

        <a href="<?php echo base_url(); ?>user/kelola_data/daftar/print" class="nav-link">
            <i class="fa fa-fw fa-print text-black-50"></i>
            <span class="text-black-50">Print Data</span>
        </a>
    </li>
